...
import com.tu.tucloudpicturebackend.model.dto.user.*;
import com.tu.tucloudpicturebackend.model.entity.User;
import com.tu.tucloudpicturebackend.model.vo.LoginUserVO;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ThrowsUtils.throwIf(userRegisterRequest == null, ErrorCode.PARAMS_ERROR);
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ThrowsUtils.throwIf(userLoginRequest == null, ErrorCode.PARAMS_ERROR);
    ...
    public BaseResponse<Boolean> userLogout(HttpServletRequest request) {
        ThrowsUtils.throwIf(request == null, ErrorCode.PARAMS_ERROR);
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest) {
        ThrowsUtils.throwIf(userAddRequest == null, ErrorCode.PARAMS_ERROR);
        User user = new User();
    ...
    public BaseResponse<Page<UserVO>> listUserVOByPage(@RequestBody UserQueryRequest userQueryRequest) {
        ThrowsUtils.throwIf(userQueryRequest == null, ErrorCode.PARAMS_ERROR);
        long current = userQueryRequest.getPageNo();
